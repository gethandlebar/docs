---
title: "Handlebar Integration with JavaScript Agents"
description: "Guide to integrating Handlebar governance into custom JavaScript agents and frameworks not directly supported with a Handlebar client."
---
...
```ts
run.afterTool(name, args, result, durationMs?, error?, tags?)
```
